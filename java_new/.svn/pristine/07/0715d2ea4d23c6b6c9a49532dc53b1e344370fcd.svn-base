...
public class AccountNumberExceedingLimitException extends UserException {

    protected static final String ERROR_CODE = "010";

    public AccountNumberExceedingLimitException() {
        super(ERROR_CODE, "账号数量超限!");
    }

    public AccountNumberExceedingLimitException(String msg) {
