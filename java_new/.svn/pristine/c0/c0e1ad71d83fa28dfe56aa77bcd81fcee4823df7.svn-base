...
public class NumberException extends EventAnalysisException {

    protected static final String USEREXPIRED = "002";

    public NumberException() {
        super(USEREXPIRED, "事件分析数量超出!");
    }

    public NumberException(String msg) {
        super(USEREXPIRED, msg);
    }
}
