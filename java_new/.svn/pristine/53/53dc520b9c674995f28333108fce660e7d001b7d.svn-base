...
public abstract class ReflectionUtils {
    ...
    private static Object handleValueType(Object obj, String propertyName,
        ...
        Method method = obtainAccessibleMethod(obj, getterMethodName);
        if(method==null){
            return value;
        }
    ...
    public static Object invokeMethod(final Object obj,
        ...
        try {
            ...
            logger.error(ReflectionUtils.class.getName() + ".invokeMethod:::" + e);
    ...
    public static Method obtainAccessibleMethod(final Object obj,
        ...
        for (; superClass != objClass; superClass = superClass.getSuperclass()) {
            ...
            try {
                ...
                // Method不在当前类定义，向上转型
                logger.error(ReflectionUtils.class.getName() + ".obtainAccessibleMethod:::" + e);
    ...
    public static Object obtainFieldValue(final Object obj,
        ...
        try {
            ...
            logger.error(ReflectionUtils.class.getName() + ".obtainFieldValue:::" + e);
        } catch (IllegalAccessException e) {
            logger.error(ReflectionUtils.class.getName() + ".obtainFieldValue:::" + e);
        }
        return retval;
    ...
    public static void setFieldValue(final Object obj, final String fieldName,
        ...
        try {
            ...
            logger.error(ReflectionUtils.class.getName() + ".setFieldValue:::" + e);
        } catch (IllegalAccessException e) {
            logger.error(ReflectionUtils.class.getName() + ".setFieldValue:::" + e);
        }
    }
    ...
    public static Field obtainAccessibleField(final Object obj,
        ...
        for (; superClass != objClass; superClass = superClass.getSuperclass()) {
            try {
                ...
                // Field不在当前类定义，向上转型
                logger.error(ReflectionUtils.class.getName() + ".obtainAccessibleField:::" + e);
            } catch (SecurityException e) {
                // Field不在当前类定义，向上转型
                logger.error(ReflectionUtils.class.getName() + ".obtainAccessibleField:::" + e);
            }
