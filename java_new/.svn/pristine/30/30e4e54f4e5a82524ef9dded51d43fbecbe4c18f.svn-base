...
public class MobileCloudUpdateUserInfoException extends MobileCloudException {
    
    /**
     * @Fields COLLECT_MODULE_CODE : 移动云用户信息异常码
     */
    public static final String MOBILECLOUD_USERERROR_CODE = "002";

    public MobileCloudUpdateUserInfoException(String msg) {
        super(MOBILECLOUD_ERROR_CODE, msg);
    }

    public MobileCloudUpdateUserInfoException() {
