...
public class DateUtil {
    ...
    public static Date StringToDate(String date, String parttern) {
        ...
        if (date != null) {
            try {
                ...
                logger.error(DateUtil.class.getName() + ".StringToDate:::" + e);
            }
        }
        return null;
    }
    ...
    public static String DateToString(Date date, String parttern) {
        ...
        if (date != null) {
            try {
                ...
                logger.error(DateUtil.class.getName() + ".DateToString:::" + e);
    ...
    public static boolean comparisonDate(String date1, String date2) {
        ...
        currentTime.setTime(StringToDate(date1));
        compareTime.setTime(StringToDate(date2));
    ...
    /**
     * 获得当前时间到前减去amount天数之间的所有日期
     *
     * @param dateStyle 日期格式
     * @param amount 数量
     * @return
     */
    public static List<String> getNewDateWithSubtractsAmountDateAllTime(DateStyle dateStyle, int amount) {
     ...
     * @return
     */
    public static String getLongDatedd() {
    ...
    /**
     * 获取当间时间字符串 yyyyMMddHHmm
     * 
     * @return
     */
    public static String getLongDatemm() {
    ...
    public static String getTimestampStr(Timestamp time){
        ...
        String tableTime = sdf.format(time);
        return tableTime;
    }
     ...
     * @return
     */
    public static String getTimestampStr(Timestamp time,DateStyle format){
     ...
     * @return
     */
    public static String getBeforeDayByHour(int beforeHour){
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
        Calendar calendar = Calendar.getInstance();
