...
public class EventAnalysisException extends BusinessException {

    /**
     * @Fields USER_SERVER_CODE : 异常码，用户模块，具体异常由具体异常类拼接
     */
    public static final String USER_MODULE_CODE = "006";

    public EventAnalysisException(String code, String msg) {
        super(USER_MODULE_CODE + code, msg);
    }

    public EventAnalysisException() {
