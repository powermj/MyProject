...
public class MobileCloudSaveSpecialInfoException extends MobileCloudException {
    
    /**
     * @Fields COLLECT_MODULE_CODE : 移动云用户信息异常码
     */
    public static final String MOBILECLOUD_USERERROR_CODE = "004";

    public MobileCloudSaveSpecialInfoException(String msg) {
        super(MOBILECLOUD_ERROR_CODE, msg);
    }

    public MobileCloudSaveSpecialInfoException() {
