...
public class ReportClassifyUpdateException extends ReportClassifyException {
    
    /**
     * @Fields CLASSIFY_OPERATE_ERR_CODE : 自定义数据分类操作异常码
     */
    public static final String CLASSIFY_OPERATE_ERR_CODE = "003";

    public ReportClassifyUpdateException(String msg) {
        super(CLASSIFY_OPERATE_ERR_CODE, msg);
    }

    public ReportClassifyUpdateException() {
