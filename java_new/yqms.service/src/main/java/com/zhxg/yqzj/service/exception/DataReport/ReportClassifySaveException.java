...
public class ReportClassifySaveException extends ReportClassifyException {
    
    /**
     * @Fields CLASSIFY_OPERATE_ERR_CODE : 自定义数据分类操作异常码
     */
    public static final String CLASSIFY_OPERATE_ERR_CODE = "001";

    public ReportClassifySaveException(String msg) {
        super(CLASSIFY_OPERATE_ERR_CODE, msg);
    }

    public ReportClassifySaveException() {
